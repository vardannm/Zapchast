...
.kaka {
	...
	background-image: radial-gradient(circle at 20% 20%, #b5b3cf 10%, #e7f8fd 50%), radial-gradient(circle at 80% 80%, #22d0e766 10%, #0033ff00 50%),
		radial-gradient(ellipse at 35% 70%, #395f7966 10%, #00ff4800 50%), radial-gradient(ellipse at 70% 35%, #1a9edb66 10%, #ff005d00 60%);
...
#card-1 .card-image {
	background-image: url("./assets/slider/3.png");
}
#card-2 .card-image {
	background-image: url("./assets/slider/1.png");
}
#card-3 .card-image {
	background-image:url("./assets/slider/5.png");
}
